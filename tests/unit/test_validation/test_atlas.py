...
def test_physical_to_base_as_dataarray_attr_passes() -> None:
    """A nonlinear atlas carries physical_to_base as a displacement-field DataArray attr."""
    ds = _make_atlas()
    ds.attrs["physical_to_base"] = xr.DataArray(
